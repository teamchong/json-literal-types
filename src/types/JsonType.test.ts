...
type _8e = Expect<Equal<Parse<`-2e21`>, -2e21>>
type _8f = Expect<Equal<Parse<`1.1e-6`>, 0.0000011>>
type _8g = Expect<Equal<Parse<`-1.1e-6`>, -0.0000011>>
type _8h = Expect<Equal<Parse<`1e-7`>, 1e-7>>
type _8i = Expect<Equal<Parse<`-1e-7`>, -1e-7>>
type _8j = Expect<Equal<Parse<`1e-6`>, 0.000001>>
type _8k = Expect<Equal<Parse<`-1e-6`>, -0.000001>>
type _8l = Expect<Equal<Parse<`1.1e-7`>, 1.1e-7>>
type _8m = Expect<Equal<Parse<`-1.1e-7`>, -1.1e-7>>
type _8n = Expect<Equal<Parse<`1.1e+21`>, 1.1e+21>>
type _8o = Expect<Equal<Parse<`-1.1e+21`>, -1.1e+21>>
type _8p = Expect<Equal<Parse<`1.1e+20`>, 110000000000000000000>>
type _8q = Expect<Equal<Parse<`-1.1e+20`>, -110000000000000000000>>
type _8r = Expect<Equal<Parse<`1.23456e-21`>, 1.23456e-21>>
type _8s = Expect<Equal<Parse<`-1.23456e-21`>, -1.23456e-21>>
